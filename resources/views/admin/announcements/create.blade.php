...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <h1 class="text-2xl font-bold text-white">Crear Nuevo Anuncio</h1>
        ...
        <form action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div x-data="{ chars: {{ strlen(old('title', 0)) }}, max: 60 }">
                    ...
                    <div x-data="{ chars: {{ strlen(old('description', 0)) }}, max: 120 }">
                        <label class="block text-sm font-medium text-gray-300 mb-1">
...
<input 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div x-data="{ isActive: {{ old('is_active', false) ? 'true' : 'false' }} }">
