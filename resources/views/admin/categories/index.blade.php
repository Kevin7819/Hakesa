        ...
        <table class="w-full">
            <thead class="bg-gray-900">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-400 uppercase">Slug</th>
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-400 uppercase">Productos</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-900 transition-colors">
                    ...
                    <td class="px-6 py-4 text-gray-400 text-sm font-mono">{{ $cat->slug }}</td>
                    <td class="px-6 py-4 text-gray-400">{{ $cat->products_count }}</td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-gray-400">{{ $cat->sort_order }}</td>
                    <td class="px-6 py-4">
