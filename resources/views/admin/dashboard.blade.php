        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                        @php $colors = ['pending'=>'bg-yellow-100 text-yellow-700','confirmed'=>'bg-blue-100 text-blue-700','in_progress'=>'bg-hakesa-teal/10 text-teal-700','completed'=>'bg-green-100 text-green-700','sent'=>'bg-hakesa-pink/10 text-pink-700','cancelled'=>'bg-red-100 text-red-700']; @endphp
