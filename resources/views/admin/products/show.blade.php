    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="md:flex">
            ...
            <div class="md:w-3/5 p-8">
                ...
                @if($product->category)<span class="inline-block px-2.5 py-1 bg-hakesa-teal-light/30 text-hakesa-teal text-xs font-semibold rounded-full mb-4">{{ $product->category->name }}</span>@endif
