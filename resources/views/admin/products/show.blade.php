    ...
    <div class="bg-gray-800 rounded-2xl shadow-sm border border-gray-700 overflow-hidden">
        <div class="md:flex">
            ...
            <div class="md:w-3/5 p-8">
                ...
                @if($product->category)<span class="inline-block px-2.5 py-1 bg-gracia-secondary-light/30 text-teal-700 text-xs font-semibold rounded-full mb-4">{{ $product->category->name }}</span>@endif
