        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="relative">
                ...
                <button x-data="wishlistToggle({{ $product->id }}, {{ $inWishlist ? 'true' : 'false' }})"
                    ...
                    class="absolute top-4 right-4 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-pink-50 transition-all disabled:opacity-50"
