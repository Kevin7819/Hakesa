        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div class="relative min-h-[400px]">
                ...
                <button x-data="wishlistToggle({{ $product->id }}, {{ $inWishlist ? 'true' : 'false' }})"
                    ...
                    class="absolute top-4 right-4 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-pink-50 transition-all disabled:opacity-50 z-10"
                    aria-label="Agregar a favoritos">
                    <svg x-show="!loading" class="w-6 h-6" :fill="inWishlist ? '#F26BB5' : 'none'" stroke="#F26BB5" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
