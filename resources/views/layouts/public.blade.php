...
<body class="bg-white">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100" x-data="{ open: false, scrolled: false }" @scroll.window="scrolled = window.scrollY > 20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <a href="/" class="flex items-center gap-3">
                    <img src="{{ asset('Hakesa_logo.webp') }}" alt="Hakesa" width="51" height="48" class="h-12 w-auto">
                ...
                <div class="hidden md:flex items-center gap-6">
                    ...
                    <a href="#contacto-footer" class="text-gray-600 hover:text-hakesa-pink font-medium transition-colors">Contacto</a>
                ...
                <button @click="open = !open" aria-label="Abrir menú de navegación" class="md:hidden p-2 text-gray-600 hover:text-hakesa-pink">
                    ...
                    <svg x-show="open" x-cloak aria-hidden="true" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="open" x-cloak x-transition class="md:hidden bg-white border-t border-gray-100 shadow-lg">
            <div class="px-4 py-4 space-y-2">
                ...
                <a href="#contacto-footer" @click="open = false" class="block px-4 py-3 rounded-lg text-gray-700 hover:bg-hakesa-light hover:text-hakesa-pink font-medium">Contacto</a>
                @auth
    ...
    <!-- ═══ Footer ═══ -->
    <footer id="contacto-footer" class="bg-gray-900 text-white">
