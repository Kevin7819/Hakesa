        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-6">
                    ...
                    @auth
                        <a href="{{ route('wishlist.index') }}" aria-label="Mis favoritos" class="relative text-gray-600 hover:text-hakesa-pink transition-colors" x-data="{ wishlistBouncing: false }" @wishlist-bounce.window="wishlistBouncing = true; setTimeout(() => wishlistBouncing = false, 500)">
                            ...
                            <span x-show="$store.wishlist.count > 0" x-text="$store.wishlist.count" x-cloak class="absolute -top-2 -right-2 w-5 h-5 bg-hakesa-pink text-white text-xs rounded-full flex items-center justify-center font-bold"></span>
                        </a>
                        <a href="{{ route('cart.index') }}" aria-label="Carrito de compras" class="relative text-gray-600 hover:text-hakesa-pink transition-colors" x-data="{ bouncing: false }" @cart-bounce.window="bouncing = true; setTimeout(() => bouncing = false, 500)">
                ...
                <!-- Mobile menu button -->
                <button @click="open = !open" aria-label="Abrir menú de navegación" class="md:hidden p-2 text-gray-600 hover:text-hakesa-pink">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        <img src="{{ asset('Hakesa_logo.webp') }}" alt="Hakesa" width="43" height="40" class="h-10 w-auto brightness-0 invert">
                    </div>
                    ...
                    <div class="flex gap-4">
                        <a href="#" aria-label="Facebook de Hakesa" class="w-10 h-10 rounded-full bg-gray-800 hover:bg-hakesa-pink flex items-center justify-center transition-colors">
                        ...
                        <a href="#" aria-label="Instagram de Hakesa" class="w-10 h-10 rounded-full bg-gray-800 hover:bg-hakesa-pink flex items-center justify-center transition-colors">
                        ...
                        <a href="https://wa.me/50689926464" aria-label="WhatsApp de Hakesa" class="w-10 h-10 rounded-full bg-gray-800 hover:bg-green-500 flex items-center justify-center transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-400">
                        <li class="flex items-center gap-2">
                            ...
                            <a href="mailto:hakesa2023@gmail.com" class="hover:text-hakesa-pink transition-colors">hakesa2023@gmail.com</a>
                        </li>
                        <li class="flex items-center gap-2">
                            ...
                            <a href="tel:+50689926464" class="hover:text-hakesa-pink transition-colors">+506 8992 6464</a>
                        </li>
                        <li class="flex items-center gap-2">
