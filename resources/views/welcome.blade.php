                            ...
                            <div class="card-hakesa overflow-hidden w-full max-w-sm flex flex-col">
                                <div class="relative aspect-square">
                                    ...
                                    <button x-data="wishlistToggle({{ $product->id }}, {{ in_array($product->id, $wishlistIds) ? 'true' : 'false' }})"
                                        ...
                                        class="absolute top-3 right-3 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-pink-50 transition-all disabled:opacity-50 z-10"
